...
- `packages/server/src`: `31635`
- `packages/server/src/plugin`: `16119`
...
- [ ] 下一候选优先查看 `automation-tools / route-inspector` 里的工具结果投影、route body builder 与 JSON 包装样板，评估是否继续外移到 `plugin-sdk`
