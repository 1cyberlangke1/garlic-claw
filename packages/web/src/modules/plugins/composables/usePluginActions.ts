import type { PluginApiContext } from '@/modules/plugins/composables/usePluginApi'
...
export function usePluginActions(options: UsePluginActionsOptions) {
  ...
  return {
    ...
    savingEventLog: pluginConfig.savingEventLog,
    savingLlmPreference: pluginConfig.savingLlmPreference,
    savingRemoteAccess: pluginConfig.savingRemoteAccess,
    ...
    saveEventLog: pluginConfig.saveEventLog,
    saveLlmPreference: pluginConfig.saveLlmPreference,
    saveRemoteAccess: pluginConfig.saveRemoteAccess,
