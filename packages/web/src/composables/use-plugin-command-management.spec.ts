...
import { usePluginCommandManagement } from './use-plugin-command-management'
import * as api from '../api'

vi.mock('../api', () => ({
  listPluginCommandOverview: vi.fn(),
}))
...
describe('usePluginCommandManagement', () => {
  beforeEach(() => {
    vi.clearAllMocks()
    vi.mocked(api.listPluginCommandOverview).mockResolvedValue(createOverview())
  })
